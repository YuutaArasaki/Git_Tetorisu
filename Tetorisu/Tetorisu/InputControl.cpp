...
* 入力制御機能：押されているか判定処理
* 引数：XINPUTのボタン情報
* XINPUT_BUTTON_DPAD＿UP			(0)		//デジタル方向ボタン上
...
* XINPUT_BUTTON_LEFT＿THUMB		(6)		//左ステック押し込み
* XINPUT_BUTTON_RIGHT＿THUMB	(7)		//右ステック押し込み
* XINPUT_BUTTON＿LEFT_SHOULDER	(8)		//LBボタン
* XINPUT_BUTTON＿RIGHT_SHOULDER	(9)		//RBボタン
* XINPUT_BUTTON_A					(12)		//Aボタン
* XINPUT_BUTTON_B					(12)		//Bボタン
* XINPUT_BUTTON_X					(13)		//Xボタン
* XINPUT_BUTTON_Y					(14)		//Yボタン
...
* 引数：XINPUTのボタン情報
* XINPUT_BUTTON_DPAD＿UP			(0)			//デジタル方向ボタン上
* XINPUT_BUTTON_DPAD＿DOWN		(1)			//デジタル方向ボタン下
* XINPUT_BUTTON_DPAD＿LEFT		(2)			//デジタル方向ボタン左
* XINPUT_BUTTON_DPAD＿RIGHT		(3)			//デジタル方向ボタン右
* XINPUT_BUTTON_STATE			(4)			//STARTボタン
* XINPUT_BUTTON_BACK			(5)			//BACKボタン
* XINPUT_BUTTON_LEFT_THUMB		(6)			//左ステック押し込み
* XINPUT_BUTTON_RIGHT_THUMB		(7)			//右ステック押し込み
* XINPUT_BUTTON＿LEFT_SHOULDER	(8)		//LBボタン
* XINPUT_BUTTON＿RIGHT_SHOULDER	(9)		//RBボタン
* XINPUT_BUTTON_A					(12)		//Aボタン
* XINPUT_BUTTON_B					(12)		//Bボタン
